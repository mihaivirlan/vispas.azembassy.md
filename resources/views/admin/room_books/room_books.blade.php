...
@section('content')
    ...
    <a href="{{URL::route('admin/room_book')}}" style="color:#fff;">
                ...
                @foreach($items as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{URL::route('admin/room_book',$item->id)}}" class="edit-pencil btn btn-xs btn-primary" title="{{ trans('trans.edit') }}">
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">{{ str_limit($item->name,17) }} &nbsp;</h4>
                                        </div>
                                        <div class="modal-body">
                                            {{ trans('trans.sure-delete') }} - <strong>{{ str_limit($item->name,17) }}</strong> ?
                                        </div>
