...
@section('content')
    ...
    <h1>@lang('trans.conference_halls')</h1>

    <a href="{{URL::route('admin/conference_hall')}}" style="color:#fff;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{URL::route('admin/conference_hall',$item->id)}}" class="edit-pencil btn btn-xs btn-primary" title="{{ trans('trans.edit') }}">
                        ...
                        <td class="status">
                            @if( $item->status )
                                <span class="active" style="color: transparent;margin: 0 auto;">1</span>
                                @else <span class="no-active" style="color: transparent;margin: 0 auto;">0</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
