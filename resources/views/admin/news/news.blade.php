...
@section('content')
    ...
    ?>
    <h1>@lang('trans.news')</h1>

    <a href="{{URL::route('admin/new')}}" style="color:#fff;">
        ...
        <div class="box-body">
            <table id="news" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th class="text-center" style="padding-right: 0;"> @lang('trans.action')</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                @foreach($news as $item)
                    <tr>
                        <td><a href="{{URL::route('news',$item->$slug_user)}}"> {{$item->$title_table}}</a></td>
                        <td>{!! strip_tags(str_limit($item->$description_table, 330)) !!}</td>
                        <td class="text-center">
                            <a href="{{URL::route('admin/new',$item->id)}}" class="edit-pencil btn btn-xs btn-primary" title="{{ trans('trans.edit') }}">
